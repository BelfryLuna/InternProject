      ...
      <div class="row align-items-center">
          ...
          <div class="hero-content">
            ...
            <form action="<?= base_url(); ?>/home/hasiltrek" method="post">
              ...
              <div class="input-group input-group-lg">
                <input type="text" class="form-control" placeholder="Masukan kode pemesanan anda" aria-label="Masukan kode pemesanan anda" aria-describedby="button-addon2" name="kode_p">
        ...
        <div class="col-lg-6">
          <div class="hero-img wow fadeInUp" data-wow-delay=".5s">
            <img src="assets/img/hero/landing.png" alt="" width="4000px">
          </div>
        </div>
      </div>
    </div>
